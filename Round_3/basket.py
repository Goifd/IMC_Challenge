...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        best_bid = max(GF_theor_bid, GIFT_BASKET_best_bid)-2
        best_ask = min(GF_theor_ask, GIFT_BASKET_best_ask)+2

        BT_orders.append(Order("GIFT_BASKET", best_bid, max_bid_quant))
        BT_orders.append(Order("GIFT_BASKET", best_ask, max_ask_quant))
